...
export const Hero: React.FC = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#020617] antialiased"
      style={{
        ...
        <div className="flex flex-col items-center space-y-16">
          ...
          >
            <motion.a
              ...
              className="px-8 py-3 mb-8 rounded-full bg-black/30 text-[#00eaff] text-lg font-light tracking-wider inline-flex items-center gap-2 backdrop-blur-sm border border-[#00eaff]/20 hover:bg-[#00eaff]/10"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              transition={{
                type: "spring",
            ...
            <h1
              className="text-7xl md:text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-[#00eaff] to-white"
              style={{
                textShadow: "0 0 40px rgba(0,234,255,0.3)",
                transform: "translate3d(0,0,0)",
              }}
            >
              MD SAWOOD ALAM
            ...
            <p
              className="text-3xl md:text-4xl font-light tracking-[0.2em] text-white/70 mt-6"
          ...
          <div
            className="flex items-center justify-center gap-6 md:gap-12 flex-wrap px-4"
            style={{ transform: "translate3d(0,0,0)" }}
          >
            <SocialLink
